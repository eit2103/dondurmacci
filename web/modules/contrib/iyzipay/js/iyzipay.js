  ...
  Drupal.behaviors.iyzipayFancyCard = {
    ...
    setupCard: function () {
      ...
      $('#commerce-checkout-flow-multistep-default').submit(function () {
        ...
        var str = $("input[data-drupal-selector='edit-payment-information-add-payment-method-payment-details-number']").val().replace(/\s/g, '');
        $("input[data-drupal-selector='edit-payment-information-add-payment-method-payment-details-number']").val(str);
      });
    }
  };
